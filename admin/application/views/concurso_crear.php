        ...
        <div class="panel-body">
            ...
            <form  id="frmFormulario">
                ...
                <div class="col-md-6" style="margin-top:2%;">
                    ...
                    <input class="form-control"  required id="año" name="año" type="number" aria-describedby="nameHelp" placeholder="Ingresa el año">
                </div>
                ...
                <div class="col-md-6" style="margin-top:2%;">
                    ...
                    <input class="form-control"  required  id="inicio" name="inicio" type="date" aria-describedby="nameHelp" placeholder="Selecciona la fecha de inicio">
                </div>


                <div class="col-md-6" style="margin-top:2%;">
                    <label for="exampleInputName">Fecha de cierre</label>
                    <input class="form-control"  required  id="cierre" name="cierre" type="date" aria-describedby="nameHelp" placeholder="Selecciona la fecha de cierre" >
                </div>
                <div class="col-md-6" style="margin-top:2%;">
                    <label for="exampleInputLastName">Fecha de premiación</label>
                    <input class="form-control"  required   id="premiacion" name="premiacion" type="date" aria-describedby="nameHelp" placeholder="Selecciona la fecha de premiación">
                </div>
